 ...
 */
{
    ...
    class Content {
        constructor(el) {
            ...
            this.DOM.link = this.DOM.el.querySelector('.button');
        ...
        show() {
            ...
            TweenMax.staggerTo([this.DOM.backCtrl,this.DOM.number,this.DOM.title,this.DOM.subtitle,this.DOM.text,this.DOM.link], 0.8, {
                ease: Power4.easeOut,
                delay: 0.4,
                opacity: 1,
                startAt: {y: 40},
        ...
        hide() {
            ...
            TweenMax.staggerTo([this.DOM.backCtrl,this.DOM.number,this.DOM.title,this.DOM.subtitle,this.DOM.text,this.DOM.link].reverse(), 0.3, {
                ease: Power3.easeIn,
                opacity: 0,
                y: 10
            }, 0.01);
    ...
    class Slideshow {
        constructor(el) {
            ...
            //buttons
            this.buttons=document.querySelectorAll('.dir');
        ...
        initEvents() {
            ...
            {
                // console.log(this.clickFn1);
                button.addEventListener('click',() => this.clickFn1(button.classList.contains("nav--prev")));
            }
